...
Source0  : https://github.com/TigerVNC/tigervnc/archive/v1.13.1/tigervnc-1.13.1.tar.gz
...
Patch2: tigervnc-manpages.patch
Patch3: tigervnc-utilize-system-crypto-policies.patch
...
%prep
%setup -q -n tigervnc-1.13.1
cd %{_builddir}
tar xf %{_sourcedir}/xorg-server-21.1.1.tar.xz
cd %{_builddir}/tigervnc-1.13.1
mkdir -p unix/xserver2/
cp -r %{_builddir}/xorg-server-21.1.1/* %{_builddir}/tigervnc-1.13.1/unix/xserver2/
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700520096
...
cp %{_builddir}/tigervnc-%{version}/java/com/tigervnc/vncviewer/LICENCE.TXT %{buildroot}/usr/share/package-licenses/tigervnc/7f7891bc33f6ac443bf927b136696eba605d1d6b || :
