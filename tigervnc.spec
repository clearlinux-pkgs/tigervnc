...
Source0  : https://github.com/TigerVNC/tigervnc/archive/v1.10.0/tigervnc-1.10.0.tar.gz
...
%prep
%setup -q -n tigervnc-1.10.0
cd %{_builddir}
tar xf %{_sourcedir}/xorg-server-1.20.5.tar.bz2
cd %{_builddir}/tigervnc-1.10.0
mkdir -p unix/xserver2/
cp -r %{_builddir}/xorg-server-1.20.5/* %{_builddir}/tigervnc-1.10.0/unix/xserver2/
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574074570
...
cp %{_builddir}/tigervnc-1.10.0/LICENCE.TXT %{buildroot}/usr/share/package-licenses/tigervnc/7f7891bc33f6ac443bf927b136696eba605d1d6b
cp %{_builddir}/tigervnc-1.10.0/java/com/jcraft/jsch/LICENSE.txt %{buildroot}/usr/share/package-licenses/tigervnc/3d04bb5917db27f91a65e93cb6b0867f6e029b09
cp %{_builddir}/tigervnc-1.10.0/java/com/jcraft/jzlib/LICENSE.txt %{buildroot}/usr/share/package-licenses/tigervnc/6ccf1d8a00f7c9c080bd538df6fd585d39954596
cp %{_builddir}/tigervnc-1.10.0/java/com/tigervnc/vncviewer/LICENCE.TXT %{buildroot}/usr/share/package-licenses/tigervnc/7f7891bc33f6ac443bf927b136696eba605d1d6b
cp %{_builddir}/tigervnc-1.10.0/unix/xserver2/COPYING %{buildroot}/usr/share/package-licenses/tigervnc/11d1ae389a1a78f7832586e4c2a0c3c7263b7475
%make_install
%find_lang tigervnc
